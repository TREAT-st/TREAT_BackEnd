...
import com.example.demo.api.common.dto.ExampleHolder;
...
public class SwaggerConfig {
    ...
    private Info swaggerInfo() {
        ...
        license.setUrl("https://github.com/TREAT-st/TREAT_BackEnd");
        license.setName("TREAT");

        return new Info()
                .version("v0.0.1")
                .title("\"TREAT 서버 API문서\"")
                .description("TREAT 서버의 API 문서 입니다.")
                .license(license);
    }
    ...
    private void generateErrorStatusResponseExample(
            io.swagger.v3.oas.models.Operation operation, Class<? extends BaseErrorCode> type) {
